...
$requiredFiles = @(
    ...
    "app\photobooth-coiffure\[slug]\cam\page.js",
...
Write-Host "- Endpoint: https://photoboothia-resource.services.ai.azure.com/..."
...
Write-Host "2. Tapez la commande de test JavaScript"
Write-Host "3. Surveillez les logs pour voir quel service répond"

Write-Host ""
Write-Host "📝 Logs à surveiller:" -ForegroundColor Magenta
Write-Host "- 'Replicate successful' = Replicate a fonctionné"
Write-Host "- 'Replicate failed' = Fallback vers Azure"
Write-Host "- 'Azure AI successful' = Azure a pris le relais"
