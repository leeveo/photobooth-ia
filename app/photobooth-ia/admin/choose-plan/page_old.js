...
const ADDON_PACKS = [
	...
	{
		id: 'addon-500', 
		name: 'Pack +500 Ph			<div className="max-w-4xl mx-auto mt-16 text-center">
				...
				<div className="max-w-4xl mx-auto mt-16 mb-16">
					<div className="bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-2xl p-8 text-center">
						...
						<div className="inline-flex items-center text-amber-700 bg-amber-100 px-4 py-2 rounded-lg">
							<span className="text-sm font-medium">💡 Astuce : Commencez par le plan Starter pour débloquer cette fonctionnalité</span>
						</div>
					</div>
				</div>
			)}
