...
import PrinterConfigManager from '../components/PrinterConfigManager';
...
export default function ProjectDetails({ params }) {
  ...
  // États pour la configuration de l'imprimante
  ...
  // Charger la configuration de l'imprimante depuis le projet
  useEffect(() => {
    if (project) {
      console.log('📄 Loading printer config from project:', {
        printer_enabled: project.printer_enabled,
        printer_ip: project.printer_ip,
        printer_endpoint: project.printer_endpoint,
        printer_copies: project.printer_copies,
        printer_format: project.printer_format
      });
        ...
        <div className="p-6 bg-white rounded-xl shadow-sm">
          ...
          {activeTab === 'email' && (
            <div>
              ...
              {/* Encart Configuration de l'imprimante */}
