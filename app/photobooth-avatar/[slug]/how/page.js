...
export default function HowToUse({ params }) {
  ...
  // First, ensure fetchProjectData is wrapped in useCallback to prevent infinite loops
  ...
  // Fix the useEffect at line 32 to include fetchProjectData in its dependency array
  useEffect(() => {
  ...
  const goToStyles = () => {
    router.push(`/photobooth-avatar/${slug}/style`);
  };
