...
export default function StyleSelectionPage({ params }) {
  const { slug } = params;
  ...
  // Since this is a Logo Fusion type, we'll go straight to the camera
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-4">
        <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
          ...
          <p className="text-gray-700 mb-6">The requested project could not be found or is inactive.</p>
          <Link href="/" className="text-blue-600 hover:underline">
            Return to home
          </Link>
        </div>
  ...
  return (
    ...
    >
      <div className="bg-white rounded-xl shadow-xl p-8 max-w-3xl w-full">
        <h1 className="text-3xl font-bold text-center mb-6" style={{ color: primaryColor }}>
          Logo Fusion Experience
        </h1>
        
        <p className="text-lg text-center mb-8">
          Pour cette expérience, nous allons fusionner votre photo avec un logo personnalisé.
        </p>
        ...
        <div className="p-6 mb-8 bg-gray-50 rounded-lg border border-gray-200">
          ...
          <ol className="list-decimal pl-5 space-y-2">
            <li>Vous allez prendre une photo avec la webcam</li>
            <li>Notre IA va fusionner votre photo avec un logo personnalisé</li>
            <li>Vous pourrez télécharger ou partager le résultat final</li>
          </ol>
        </div>
        ...
        <div className="flex justify-center">
          <button
            ...
            className="px-8 py-4 rounded-lg font-bold text-white text-lg shadow-lg transition-transform transform hover:scale-105"
            style={{ backgroundColor: primaryColor }}
          >
            Continuer vers l'appareil photo
          </button>
        </div>
      </div>
    </div>
