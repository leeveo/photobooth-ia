...
export default function PremiumPhotoboothLayout({ children, params }) {
  ...
  // Main page: /photobooth-premium/[slug] 
  // Sub-pages: /photobooth-premium/[slug]/cam, /photobooth-premium/[slug]/how, etc.
  const pathSegments = pathname.split('/').filter(Boolean);
  const isMainPage = pathSegments.length === 2 && pathSegments[0] === 'photobooth-premium' && pathSegments[1] === slug;
