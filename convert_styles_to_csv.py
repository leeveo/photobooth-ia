...
# Define file paths - using relative paths assuming script is run from workspace root
json_file_path = r'app/photobooth-ia/admin/components/styleTemplatesData.json'
csv_file_path = r'styles_export.csv'
...
def convert_json_to_csv():
    try:
        ...
        if not os.path.exists(json_file_path):
            ...
            json_file_path_abs = os.path.join(os.getcwd(), 'app', 'photobooth-ia', 'admin', 'components', 'styleTemplatesData.json')
